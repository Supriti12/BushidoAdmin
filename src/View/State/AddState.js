...
const AddState = () => {
  ...
  const onDelete = (id) => {
      ...
      Swal.fire({
          ...
          if (result.isConfirmed) {
              ...
              HomeService.DeleteBlogCategory(id)
              .then((res) => {
  ...
  const AddBlogCategory = () =>{
      ...
      if(name){
        HomeService.addBlogCategory(data)
        .then((res) => {
...
<div className="main-card mb-3 card">
 <div className="card-body">
   ...
   <div class="form-group">
    ...
    {
        hide ?    <button  class="btn btn-primary" onClick={AddBlogCategory}>
        Submit
      </button> :    <button  class="btn btn-primary" onClick={UpdateBlogCategory}>
       Update
   </button>
    }
